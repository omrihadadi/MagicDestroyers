...
namespace MagicDestroyers
{
    public static class PlayersInfo
    {
        ...
        private static string playersNames = "Names.txt";
        ...
        private static FileInfo playersNamesFile = new FileInfo(playersInfoDirectoryPath + playersNames);
        ...
        public static void GiveNames (List<Character> characters)
        {
            using (StreamReader sr = playersNamesFile.OpenText())
            {
                string line = string.Empty;
                ...
                foreach (var character in characters)
                {
                    character.Name = names[rng.Next(0,names.Count-1)];
                }
